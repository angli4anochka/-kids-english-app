...
export default function SpotlightEx38({ isTeacher, lessonId, activityId, sessionId }: Props) {
  ...
  const src = `/spotlight/ex38.html${params.toString() ? '?' + params.toString() : ''}`;
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13 }}>
              <thead>
                <tr style={{ background: '#f5f5f5', position: 'sticky', top: 0 }}>
                  ...
                  <th style={{ padding: '6px 10px', textAlign: 'left', borderBottom: '1px solid #e0e0e0' }}>Ответы (1–20)</th>
                </tr>
              </thead>
              <tbody>
                {results.map(r => {
