      ...
      try {
        await fetch('/kids-api/spotlight/results', {
          ...
          body: JSON.stringify({
            ...
            results: [
              ...TASKS1.map((t, i) => ({ questionIndex: i,                                          studentAnswer: answers1[i], correctAnswer: t.answer, isCorrect: isCorrect1(i), sentence: `${t.before} ${t.answer} ${t.after}` })),
              ...TASKS2.map((t, i) => ({ questionIndex: TASKS1.length + i,                         studentAnswer: answers2[i], correctAnswer: t.answer, isCorrect: isCorrect2(i), sentence: `${t.before} ${t.answer} ${t.after}` })),
              ...TASKS3.map((t, i) => ({ questionIndex: TASKS1.length + TASKS2.length + i,         studentAnswer: answers3[i], correctAnswer: t.answer, isCorrect: isCorrect3(i), sentence: `${t.before} ${t.answer} ${t.after}` })),
              ...TASKS4.map((t, i) => ({ questionIndex: TASKS1.length + TASKS2.length + TASKS3.length + i, studentAnswer: answers4[i], correctAnswer: t.answer, isCorrect: isCorrect4(i), sentence: `${t.before} ${t.answer} ${t.after}` })),
            ],
