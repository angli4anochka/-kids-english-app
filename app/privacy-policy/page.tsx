      ...
      <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-sm p-8 md:p-12">
        ...
        <Section title="2. Категории пользователей и обрабатываемые данные">
          ...
          <SubSection title="2.2 Учителя (преподаватели)">
            <p>Имя (отображаемое), адрес электронной почты, хэш пароля, цвет аватара, дата регистрации, информация о подписке (тариф, дата истечения).</p>
          </SubSection>
        ...
        <Section title="6. Передача данных третьим лицам">
          ...
          <p className="mt-2 text-sm text-blue-700 bg-blue-50 p-2 rounded">
            <strong>Трансграничная передача данных:</strong> Не осуществляется. Все компоненты платформы (сервер, БД, шрифты) размещены на территории РФ. Иностранные сервисы аналитики, авторизации и хранения данных не используются.
          </p>
        </Section>
