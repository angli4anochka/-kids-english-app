      ...
      <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-sm p-8 md:p-12">
        ...
        <Section title="6. Передача данных третьим лицам">
          ...
          <ul className="mt-2 space-y-1 list-disc pl-5">
            <li><strong>Платёжный провайдер</strong> ([название провайдера]) — для обработки платежей. Имя и email покупателя.</li>
            <li><strong>Провайдер хостинга</strong> — Яндекс.Облако (Россия) — для хранения данных и работы сервера.</li>
            <li><strong>Провайдер email-уведомлений</strong> — [название сервиса, если используется] — email для уведомлений.</li>
          ...
          <p className="mt-2 text-sm text-blue-700 bg-blue-50 p-2 rounded">
            <strong>Трансграничная передача данных:</strong> В настоящее время платформа не использует иностранные сервисы аналитики, рекламы или хранения данных. Шрифты Google Fonts загружаются с серверов Google (IP, User-Agent могут передаваться). При подключении иностранных сервисов настоящая Политика будет обновлена.
          </p>
        </Section>
