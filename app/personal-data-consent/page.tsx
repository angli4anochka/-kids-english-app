      ...
      <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-sm p-8 md:p-12">
        ...
        <Section title="5. Передача данных третьим лицам">
          ...
          <ul className="mt-2 space-y-1 list-disc pl-5">
            ...
            <li><strong>Платёжному провайдеру</strong> — [название] — имя и email для проведения платежей;</li>
            <li>Государственным органам — по основаниям, предусмотренным законодательством РФ.</li>
          </ul>
          <p className="mt-2">
            Трансграничная передача персональных данных в настоящее время не осуществляется.
          </p>
        </Section>
