...
const BADGES = [
  ...
  { threshold: 100, emoji: '🥈', name: 'Старатель' },
  { threshold: 150, emoji: '🥇', name: 'Молодец' },
  { threshold: 200, emoji: '🏆', name: 'Чемпион' },
  { threshold: 250, emoji: '💎', name: 'Знаток' },
  { threshold: 300, emoji: '👑', name: 'Легенда' },
];
...
export default function StudentProfileScreen() {
  ...
  useEffect(() => {
    ...
    fetch(`/kids-api/students/${user.id}`)
      .then((r) => r.json())
      .then((d) => {
        if (d.success && d.data) setPoints(d.data.points || 0);
      })
      .catch(() => {})
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-100 via-purple-100 to-pink-100 p-4">
      <div className="max-w-3xl mx-auto">
        ...
        {/* Шапка профиля */}
        <div className="bg-white rounded-3xl shadow-2xl p-6 mb-5 flex items-center gap-5">
          <div
        ...
        {/* Баллы + уровень */}
        <div className="bg-gradient-to-br from-amber-400 to-orange-500 rounded-3xl shadow-2xl p-6 mb-5 text-white">
